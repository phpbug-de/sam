...
$box_smarty->assign('FORM_ACTION', '<form id="quick_find" class="navbar-search" method="get" action="'.xtc_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', $request_type, false).'">');
...
$box_smarty->assign('INPUT_SEARCH', xtc_draw_input_field('keywords', '', 'class="span6" placeholder="Suche"')); // @todo sgi: sprachdatei verwenden
